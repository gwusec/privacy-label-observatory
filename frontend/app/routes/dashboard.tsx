  ...
  return (
    <div id="main-text">
      ...
      <div className="mb-16">
        ...
        <a href="#track" className="text-md text-slate-400 font-medium hover:text-white text-center mb-4 block" onclick="smoothScroll(event, '#track')">Data Used to Track You</a>
        <a href="#linked" className="text-md text-slate-400 font-medium hover:text-white text-center mb-4 block" onclick="smoothScroll(event, '#linked')">Data Linked to You</a>
        <a href="#n_linked" className="text-md text-slate-400 font-medium hover:text-white text-center mb-4 block" onclick="smoothScroll(event, '#n_linked')">Data Not Linked to You</a>
        <a href="#n_collected" className="text-md text-slate-400 font-medium hover:text-white text-center mb-32 block" onclick="smoothScroll(event, '#n_collected')">Data Not Collected</a>
      </div>


      <div id="track" class="min-h-screen flex items-center justify-center">
        <h1 class="text-3xl">Data Used to Track You</h1>
        <p className="text-lg text-slate-300 font-medium text-center mb-4">Data collected may be used to track users across apps and websites owned by other companies, including sharing data with third-party advertising networks and data brokers.</p>
      </div>

      <div id="linked" class="min-h-screen items-center justify-center">
        <h1 class="text-3xl block">Data Linked to You</h1>
        <p className="text-lg text-slate-300 font-medium text-center mb-4">Data is collected and is linked to the user’s identity.</p>
      </div>
      
      <div id="n_linked" class="min-h-screen items-center justify-center">
        <h1 class="text-3xl block">Data Not Linked to You</h1>
        <p className="text-lg text-slate-300 font-medium text-center mb-4">Data is collected but is de-identified or anonymized and is therefore not linked to the user’s identity.</p>
      </div>
      
      <div id="n_collected" class="min-h-screen flex items-center justify-center">
        <h1 class="text-3xl">Data Not Collected</h1>
        <p className="text-lg text-slate-300 font-medium text-center mb-4">When an app adds a label with the Data Not Collected Privacy Type, it states that it does not collect any data from the user, and therefore does not include other Privacy Types.</p>
      </div>
