  ...
  return (
    <div className="overflow-y-hidden">
      {state === "loading" ?
        ...
        :
        <div className={`min-h-fit overflow-visible ${theme === 'dark' ? 'bg-dark' : 'bg-light'}`}>
          <div id="main-text">
            <div>
              <div className={`${isPopupOpen ? 'hidden' : ''} fixed left-0 top-20 flex flex-col space-y-4 p-4 items-start`}>
              ...
              <div style={{ width: '80%', margin: '0 auto' }}>
                ...
                <div className={`mb-60 `} ref={(el => (refs.current[7] = el))}>
