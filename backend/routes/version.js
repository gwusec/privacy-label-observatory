...
router.get('/', async function(req, res){
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/versionHelper?name=dnc&run=${latestRun}`)
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/versionHelper?name=dnlty&run=${latestRun}`)
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/versionHelper?name=dlty&run=${latestRun}`)
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/versionHelper?name=duty&run=${latestRun}`)
