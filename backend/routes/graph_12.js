...
router.get('/', async function(req, res){
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/helper12?name=dnc&run=${latestRun}`)
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/helper12?name=dnlty&run=${latestRun}`)
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/helper12?name=dlty&run=${latestRun}`)
    ...
    var request = await axios.get(`http://localhost:${process.env.BACKEND_PORT}/api/helper12?name=duty&run=${latestRun}`)
