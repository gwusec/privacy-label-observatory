...
router.get('/', async function(req, res){
    ...
    var request = await axios.get('http://localhost:8017/helper11?name=dnc')
    ...
    var request = await axios.get('http://localhost:8017/helper11?name=dnlty')
    ...
    var request = await axios.get('http://localhost:8017/helper11?name=dlty')
    ...
    var request = await axios.get('http://localhost:8017/helper11?name=duty')
