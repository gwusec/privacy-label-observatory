...
app.use("/api/graph16", graph16Router)
app.use("/api/helper", helperRouter)
app.use("/api/graph11", graph11Router)
app.use("/api/helper11", helper11Router)
app.use("/api/graph12", graph12Router)
app.use("/api/helper12", helper12Router)
app.use("/api/figure7", figure7Router)
app.use("/api/figure8", figure8Router)
app.use("/api/figure13", figure13)
app.use("/api/graph14", graph14Router)
app.use("/api/graph14helper", graph14Helper)
app.use("/api/graph15", graph15Router)
app.use("/api/helper15", graph15Helper)
