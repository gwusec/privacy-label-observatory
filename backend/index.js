...
var percentageHelper = require("./routes/percentageHelper")
var versionRouter = require("./routes/version")
var versionHelper = require("./routes/versionHelper")
var ratingRouter = require("./routes/rating")
var ratingHelper = require("./routes/ratingHelper")
var yearlyReleasesRouter = require("./routes/yearlyReleases")
var yearlyReleasesHelper = require("./routes/yearlyReleasesHelper")
var sizeRouter = require("./routes/size")
var sizeHelper = require("./routes/sizeHelper")
...
app.use("/api/percentageHelper", percentageHelper)
app.use("/api/version", versionRouter)
app.use("/api/versionHelper", versionHelper)
app.use("/api/rating", ratingRouter)
app.use("/api/ratingHelper", ratingHelper)
...
app.use("/api/yearlyReleasesHelper", yearlyReleasesHelper)
app.use("/api/size", sizeRouter)
app.use("/api/sizeHelper", sizeHelper)
