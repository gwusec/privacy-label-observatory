...
def transform_old_to_new(old_data):
    ...
    transformed_data = {
        ...
        "app_url": old_data["app_url"], #Added the app_url from the old database to the new database
    ...
    metadata = {
        ...
        "image_url": "",  # Might make the web_url into the image url, since we don't include the web_url
